...
public class NhanVienDao extends EduSysDao<NhanVien, String> {
    ...
    final String ByID = "SELECT maNV,matKhau,hoTen,vaiTro FROM NHANVIEN WHERE MANV=?";

    @Override
    public void insert(NhanVien entity) {
        DBconnect.update(Insert, entity.getMaNV(), entity.getMatKhau(), entity.getHoTen(), entity.isVaiTro());
    }

    @Override
    public void update(NhanVien entity) {
        DBconnect.update(Update, entity.getMatKhau(), entity.getHoTen(), entity.isVaiTro(), entity.getMaNV());
    }

    @Override
    public void delete(String id) {
        DBconnect.update(Delete, id);
    }
