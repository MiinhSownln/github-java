...
public class QuanLyDiem extends javax.swing.JDialog {
    ...
    SinhVienDAO dSV = new SinhVienDAO();
...
//    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtFind.getText().isEmpty()) {
            ...
            SinhVien sv = dSV.getSinhVienByID(txtFind.getText());
            if (sv != null) {
    ...
    public Grade readForm() {
        ...
        gr.setMaSV(sv);
        gr.setTiengAnh(Integer.parseInt(Ta.getText()));
        gr.setTinHoc(Integer.parseInt(Th.getText()));
        gr.setTheChat(Integer.parseInt(Gdtc.getText()));
    ...
    public void showData(int index) {
        ...
        Gdtc.setText(String.valueOf(g.getTheChat()));
        txtMa.setText(g.getMaSV().getMaSDV());
        txtHoten.setText(g.getMaSV().getTenSV());
